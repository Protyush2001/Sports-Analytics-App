...
//   if (loading) {
//     return <div className="text-center py-4">Loading points table...</div>;
//   }
...
//       <h2 className="text-2xl font-bold mb-4 text-center">Tournament Points Table</h2>
...
//               teams.map((team) => (
//                 <tr key={team._id || team.name} className="border-t">
//                   <td className="px-4 py-2">{team.name}</td>
//                   <td className="px-4 py-2 text-center">{team.matchesPlayed ?? 0}</td>
//                   <td className="px-4 py-2 text-center">{team.wins ?? 0}</td>
//                   <td className="px-4 py-2 text-center">{team.losses ?? 0}</td>
//                   <td className="px-4 py-2 text-center font-semibold">{team.points ?? 0}</td>
//                 </tr>
//               ))
//             ) : (
//               <tr>
