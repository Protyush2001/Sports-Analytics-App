...
// import ChatBot from "./ChatBot"; // your full chat window component
...
//       {/* Floating Icon */}
//       <div
//         className="fixed bottom-6 right-6 z-50 cursor-pointer bg-blue-600 text-white p-4 rounded-full shadow-lg hover:bg-blue-700 transition"
...
//       {/* Chat Popup */}
//       {isOpen && (
//         <div className="fixed bottom-20 right-6 z-50 w-80 bg-white shadow-xl rounded-lg overflow-hidden">
