...
router.post('/:matchId/start-stream', authenticateUser, customMatchController.startStream);
router.post('/:matchId/stop-stream', authenticateUser, customMatchController.stopStream);
